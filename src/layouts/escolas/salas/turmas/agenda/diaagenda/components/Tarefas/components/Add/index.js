 ...
 * @param {Function} props.handleAddTarefa - Função para adicionar a tarefa.
 * @param {Function} props.handleOffAdd - Função para cancelar a adição da tarefa.
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          <MDBox display="flex" flexDirection="row" justifyContent="center">
            <MDBox mr={1}>
              <MDButton variant="gradient" color="success" onClick={handleAddTarefa}>
                Salvar
              </MDButton>
            </MDBox>
            <MDBox ml={1}>
