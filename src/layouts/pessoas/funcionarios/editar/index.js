...
/**
 * Componente para edição de funcionário.
 * @module pessoas/funcionarios
 * @returns {JSX.Element} Componente de edição de funcionário.
 */
function EditarFuncionario() {
  ...
  /**
   * Manipulador de evento para editar um funcionário.
   */
  ...
  /**
   * Manipulador de evento para cancelar a edição de um funcionário.
   */
